...
type ChangeRoomReply struct {
	IsRoomMessage        bool     `protobuf:"varint,1,opt,name=isRoomMessage,proto3" json:"isRoomMessage,omitempty"`
	IsMessage            bool     `protobuf:"varint,2,opt,name=isMessage,proto3" json:"isMessage,omitempty"`
	IsRedEnvelope        bool     `protobuf:"varint,3,opt,name=isRedEnvelope,proto3" json:"isRedEnvelope,omitempty"`
	HeaderMessage        []byte   `protobuf:"bytes,4,opt,name=headerMessage,proto3" json:"headerMessage,omitempty"`
...
func (m *ChangeRoomReply) GetIsRoomMessage() bool {
	if m != nil {
		return m.IsRoomMessage
	}
	return false
}

func (m *ChangeRoomReply) GetIsMessage() bool {
	if m != nil {
		return m.IsMessage
	}
	return false
...
func (m *ChangeRoomReply) GetIsRedEnvelope() bool {
	if m != nil {
		return m.IsRedEnvelope
	}
	return false
...
func (m *ChangeRoomReply) GetMessage() string {
	if m != nil {
		return m.Message
	}
	return ""
...
var fileDescriptor_60207fea82c31ca8 = []byte{
	...
	,
}
...
func (m *ChangeRoomReply) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsRoomMessage", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
