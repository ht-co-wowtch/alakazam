...
type ConnectReply struct {
	...
	TopMessage           []byte   `protobuf:"bytes,9,opt,name=topMessage,proto3" json:"topMessage,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_60207fea82c31ca8 = []byte{
	...
	0xab, 0x24, 0x86, 0xd2, 0xa0, 0xc1, 0xb8, 0xdf, 0xc2, 0xe8, 0x32, 0x92, 0xab, 0x5a, 0xc7, 0xf7,
	...
	0xe5, 0xa1, 0xfa, 0x15, 0x7d, 0xf6, 0x5f, 0x00, 0x00, 0x00, 0xff, 0xff, 0x5b, 0x51, 0x50, 0xce,
	0xcc, 0x06, 0x00, 0x00,
}
